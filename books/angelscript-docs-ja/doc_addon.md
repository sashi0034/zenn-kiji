...
参照: サンプルの [concurrent](./doc_samples) および [corout](./doc_samples)
...
スクリプトインターフェースについては [コルーチン](./doc_script_stdlib) を参照してください。
...
スクリプトインターフェースについては [例外処理](./doc_script_stdlib) を参照してください。
